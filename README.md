...
1. **Quantize**: Convert each channel to integer (0–49)
1. **Mask**: Apply rejection-sampled salt + wave interference per document
1. **Store**: Keep only modular residues (mod prime)
1. **Search**: Compare in modular space — raw embedding never reconstructed
